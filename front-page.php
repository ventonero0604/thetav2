<?php get_header(); ?><a class="p-top-bnr" href="https://theta-online.jp/theta_tgc/" target="_blank" rel="noopener noreferrer">
  <picture>
    ...
    <div class="l-wrapper">
      <main class="l-main">
        ...
        <div class="p-top-products">
          <h2 class="p-top-products__ttl u-uppercase wf-oswald c-ttl-top" style="font-size: 9vw;">Theta Products </h2>
        ...
        <div class="p-top-space">
            ...
            <div class="swiper-container">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/img/top/01-min.png" alt="THETA SPACE">
                </div>
                <div class="swiper-slide">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/img/top/02-min.png" alt="THETA SPACE">
                </div>
                <div class="swiper-slide">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/img/top/03-min.png" alt="THETA SPACE">
                </div>
                <div class="swiper-slide">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/img/top/04-min.png" alt="THETA SPACE">
                </div>
                <div class="swiper-slide">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/img/top/05-min.png" alt="THETA SPACE">
                </div>
              </div>
            </div>
          </div>
          ...
          <!--banner-->
          <!-- <a href="https://theta-online.jp/theta_tgc/interview.html"><img style="max-width: 1500px; width:90%; margin-left: auto; margin-right: auto; margin-top: 100px" src="https://theta-online.jp/theta_tgc/img/banner_thetapeople.png" alt="THETA PEOPLE 阿部なつき スペシャルインタビュー | ヒロマツホールディングス presents TGC HIROSHIMA 2025 by TOKYO GIRLS COLLECTION THETA アンバサダー"></a> -->
        </div>
...
<script>
  var mySwiper = new Swiper('.swiper-container', {
    ...
    speed: 2500, // 2.5秒かけてフェードアニメーションを実行

    // ★★★ ページネーションに関する以下の設定を削除しました ★★★
    /*
    pagination: {
